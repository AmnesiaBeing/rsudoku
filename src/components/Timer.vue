  ...
  <div class="timer mt-3">
    ...
    <div>
      ...
      >
        ...
        ></path>
        <path
          d="M512 287.4c22.6 0 41 18.3 41 41V501c0 22.6-18.3 41-41 41-22.6 0-41-18.3-41-41V328.3c0-22.6 18.4-40.9 41-40.9z"
          fill="#94a3b8"
          p-id="1863"
        ></path>
        <path
          d="M789.8 663.2c-11.3 19.6-36.4 26.3-55.9 15L492.2 538.6c-19.6-11.3-26.3-36.4-15-55.9 11.3-19.6 36.4-26.3 55.9-15l241.7 139.5c19.6 11.3 26.3 36.4 15 56z"
          fill="#94a3b8"
          p-id="1864"
        ></path>
      </svg>
